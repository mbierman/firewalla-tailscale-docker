...
```bash
curl -sL https://raw.githubusercontent.com/mbierman/firewalla-tailscale-docker/refs/heads/main/install.sh?token=GHSAT0AAAAAADNA3IRLPFOMUUKTSGCQ3GPW2IRD4FA | sudo bash
```
