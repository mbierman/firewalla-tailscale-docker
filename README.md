...
```bash
curl -sL https://raw.githubusercontent.com/mbierman/firewalla-tailscale-docker/refs/heads/main/install.sh?token=GHSAT0AAAAAADNA3IRKITLPJB54VBZIL2IG2IRDYVA | sudo bash
```
